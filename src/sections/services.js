...
const SERVICES_DATA = [
  ...
  },
  {
    image: serviceImage3,
    text:
      'Thinking of building an hybrid application? I got you covered.',
  ...
  },
  {
    image: serviceImage6,
    text:
      'Want to kickstart an e-commerce store? Shoot out a message!.',
  ...
  return (
    <Box as="section" id="services" sx={styles.services}>
      <Container>
        <BlockTitle
          title="Services"
          text="What services do I have to offer?"
        />
        <Grid sx={styles.grid}>
